...
#        print(probe.get("id"),probe.get("hostname"),probe.get("networkInterfacesReceived_eth1"))
    row={
    ...
    for i,probe in data["probes"].items():
        hostname_key ="probes["+str(probe.get("id"))+"].hostname"
#        print(hostname_key,probe.get("hostname"))
